...
sed -i -e "s/172.31.7.198/todo.bethas.online/" /etc/nginx/sites-enabled/default.config && sed -i -e "s/172.31.4.145/login.bethas.online/" /etc/nginx/sites-enabled/default.config
